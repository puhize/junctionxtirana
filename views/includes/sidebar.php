...
<div class="logo">
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            <li class="<?= basename($_SERVER['PHP_SELF']) == 'all_tasks.php' ? 'active' : '' ?>"><a href="all_tasks.php"><i class="nc-icon nc-paper"></i><p>Dashboard</p></a></li>
            <li class="<?= basename($_SERVER['PHP_SELF']) == 'manager_dashboard.php' ? 'active' : '' ?>"><a href="manager_dashboard.php"><i class="nc-icon nc-watch-time"></i><p>Tasks</p></a></li>
